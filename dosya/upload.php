<?php 
	...
	$uploadOk = 2;
	$FileType = pathinfo($target_file,PATHINFO_FILENAME);
    ...
    <body>
        <div class="container">
            <div class="header clearfix">
                ...
                <h3 class="text-muted"><a style="text-decoration: none;" href="index.php">Dosyalarım</a></h3>
            </div>
            <div class="jumbotron">
                <?php 
		  ...
		  $uploadok = 0;
			...
			if ($uploadOk == 0) {
				...
				if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"],$ran)) {
				  ...
				  echo "<br/>";
				  echo "<a href=\"http://aardadasdelenn.com/dosya/$dir/$dwnran\"><input type=\"submit\" class=\"btn btn-outline-primary\" value=\"İndir\"></a>";
				} else {
